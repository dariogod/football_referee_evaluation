...
class DynamicKMeansSilhouette(BaseRoleAssigner):
    """Dynamic K-means role assigner using Silhouette score for goodness metric."""
    ...
    def perform_clustering(self, valid_persons: List[PersonWithJerseyColor], 
        ...
        """
        Perform K-means clustering with iterative outlier removal using Silhouette score.
        ...
        for n_outliers in range(7):  # 0, 1, 2, 3, 4, 5, 6
            ...
            # Calculate goodness using Silhouette score
            goodness = self._calculate_silhouette_score(current_X, labels)
