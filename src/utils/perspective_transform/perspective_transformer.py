...
from src.utils.perspective_transform.util.synthetic_util import SyntheticUtil
from src.utils.perspective_transform.util.iou_util import IouUtil
from src.utils.perspective_transform.util.projective_camera import ProjectiveCamera
from src.utils.perspective_transform.models.models import create_model
from src.utils.perspective_transform.deep.siamese import BranchNetwork, SiameseNetwork
from src.utils.perspective_transform.deep.camera_dataset import CameraDataset
from src.utils.perspective_transform.arguments import Arguments
import sys
...
class PerspectiveTransformer:
    def __init__(self):
        self.query_index = 0
        self.current_directory = os.path.join("models", "perspective_transformer")
